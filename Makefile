...
PYDOCSTYLE_FILES=ddl/base.py ddl/deep.py ddl/tree.py ddl/independent.py ddl/univariate.py ddl/__init__.py ddl/autoregressive.py ddl/datasets.py ddl/gaussian.py ddl/linear.py
