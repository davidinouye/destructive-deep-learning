...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "ddl.externals.mlpack._arma_numpy",
        "sources": [
            "ddl/externals/mlpack/_arma_numpy.pyx"
        ]
    },
    "module_name": "ddl.externals.mlpack._arma_numpy"
}
END: Cython Metadata */
...
#define __PYX_HAVE__ddl__externals__mlpack___arma_numpy
#define __PYX_HAVE_API__ddl__externals__mlpack___arma_numpy
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
#define __Pyx_MODULE_NAME "ddl.externals.mlpack._arma_numpy"
int __pyx_module_is_main_ddl__externals__mlpack___arma_numpy = 0;

/* Implementation of 'ddl.externals.mlpack._arma_numpy' */
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":44
...
static arma::Mat<double>  *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_mat_d(PyArrayObject *__pyx_v_X, bool __pyx_v_takeOwnership) {
  ...
  __pyx_pybuffernd_X.rcbuffer = &__pyx_pybuffer_X;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 44, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_X.diminfo[1].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_X.diminfo[1].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[1];

  /* "ddl/externals/mlpack/_arma_numpy.pyx":49
 ...
 *     X = X.copy(order="C")
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_c_contiguous); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 49, __pyx_L1_error)
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_owndata); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 49, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":51
 *   if not (X.flags.c_contiguous or X.flags.owndata):
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")             # <<<<<<<<<<<<<<
 *     takeOwnership = True
 * 
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_copy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 51, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":52
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 *     takeOwnership = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":54
 *     takeOwnership = True
 * 
 *   cdef arma.Mat[double]* m = new arma.Mat[double](<double*> X.data, X.shape[1],\             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":58
 * 
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":59
 *   # Take ownership of the memory, if we need to.
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 *     SetMemState[arma.Mat[double]](m[0], 0)
 ...
 */
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":60
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 *     SetMemState[arma.Mat[double]](m[0], 0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":62
 *     SetMemState[arma.Mat[double]](m[0], 0)
 * 
 *   return m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.numpy_to_mat_d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":64
 *   return m
 * 
 * cdef arma.Mat[size_t]* numpy_to_mat_s(numpy.ndarray[numpy.npy_intp, ndim=2] X, \             # <<<<<<<<<<<<<<
 *                                       bool takeOwnership) except +:
...
static arma::Mat<size_t>  *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_mat_s(PyArrayObject *__pyx_v_X, bool __pyx_v_takeOwnership) {
  arma::Mat<size_t>  *__pyx_v_m;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_X;
  __Pyx_Buffer __pyx_pybuffer_X;
  arma::Mat<size_t>  *__pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  ...
  PyObject *__pyx_t_9 = NULL;
  PyObject *__pyx_t_10 = NULL;
  __Pyx_RefNannySetupContext("numpy_to_mat_s", 0);
  __Pyx_INCREF((PyObject *)__pyx_v_X);
  __pyx_pybuffer_X.pybuffer.buf = NULL;
  __pyx_pybuffer_X.refcount = 0;
  __pyx_pybuffernd_X.data = NULL;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 64, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_X.diminfo[1].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_X.diminfo[1].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[1];

  /* "ddl/externals/mlpack/_arma_numpy.pyx":69
 *   Convert a numpy ndarray to a matrix.  The memory will still be owned by numpy.
 *   """
 *   if not (X.flags.c_contiguous or X.flags.owndata):             # <<<<<<<<<<<<<<
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_c_contiguous); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_owndata); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":71
 *   if not (X.flags.c_contiguous or X.flags.owndata):
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")             # <<<<<<<<<<<<<<
 *     takeOwnership = True
 * 
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_copy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 71, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
      __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack);
      if (unlikely(__pyx_t_7 < 0)) {
        PyErr_Fetch(&__pyx_t_8, &__pyx_t_9, &__pyx_t_10);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
          Py_XDECREF(__pyx_t_8); Py_XDECREF(__pyx_t_9); Py_XDECREF(__pyx_t_10);
          __Pyx_RaiseBufferFallbackError();
        } else {
          PyErr_Restore(__pyx_t_8, __pyx_t_9, __pyx_t_10);
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":72
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 *     takeOwnership = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":74
 *     takeOwnership = True
 * 
 *   cdef arma.Mat[size_t]* m = new arma.Mat[size_t](<size_t*> X.data, X.shape[1],             # <<<<<<<<<<<<<<
 *       X.shape[0], False, False)
 * 
 */
  __pyx_v_m = new arma::Mat<size_t> (((size_t *)__pyx_v_X->data), (__pyx_v_X->dimensions[1]), (__pyx_v_X->dimensions[0]), 0, 0);

  /* "ddl/externals/mlpack/_arma_numpy.pyx":78
 * 
 *   # Take ownership of the memory, if we need to.
 *   if takeOwnership:             # <<<<<<<<<<<<<<
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":79
 *   # Take ownership of the memory, if we need to.
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 *     SetMemState[arma.Mat[size_t]](m[0], 0)
 ...
 */
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":80
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 *     SetMemState[arma.Mat[size_t]](m[0], 0)             # <<<<<<<<<<<<<<
 * 
 *   return m
 */
    SetMemState<arma::Mat<size_t> >((__pyx_v_m[0]), 0);
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":82
 *     SetMemState[arma.Mat[size_t]](m[0], 0)
 * 
 *   return m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.numpy_to_mat_s", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":84
 *   return m
 * 
 * cdef numpy.ndarray[numpy.double_t, ndim=2] mat_to_numpy_d(arma.Mat[double]& X) \             # <<<<<<<<<<<<<<
 *     except +:
...
static PyArrayObject *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_mat_to_numpy_d(arma::Mat<double>  &__pyx_v_X) {
  ...
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("mat_to_numpy_d", 0);
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":91
 *   # Extract dimensions.
 ...
 */
  (__pyx_v_dims[0]) = ((npy_intp)__pyx_v_X.n_cols);

  /* "ddl/externals/mlpack/_arma_numpy.pyx":92
 *   cdef numpy.npy_intp dims[2]
 *   dims[0] = <numpy.npy_intp> X.n_cols
 *   dims[1] = <numpy.npy_intp> X.n_rows             # <<<<<<<<<<<<<<
 *   cdef numpy.ndarray[numpy.double_t, ndim=2] output = \
 ...
 */
  (__pyx_v_dims[1]) = ((npy_intp)__pyx_v_X.n_rows);

  /* "ddl/externals/mlpack/_arma_numpy.pyx":94
 *   dims[1] = <numpy.npy_intp> X.n_rows
 *   cdef numpy.ndarray[numpy.double_t, ndim=2] output = \
 *       numpy.PyArray_SimpleNewFromData(2, &dims[0], numpy.NPY_DOUBLE, GetMemory(X))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(2, (&(__pyx_v_dims[0])), NPY_DOUBLE, GetMemory(__pyx_v_X)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 94, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_output.rcbuffer->pybuffer, (PyObject*)__pyx_t_2, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":97
 * 
 *   # Transfer memory ownership, if needed.
 ...
 */
  __pyx_t_3 = ((GetMemState<arma::Mat<double> >(__pyx_v_X) == 0) != 0);
  if (__pyx_t_3) {

    /* "ddl/externals/mlpack/_arma_numpy.pyx":98
 *   # Transfer memory ownership, if needed.
 *   if GetMemState[arma.Mat[double]](X) == 0:
 *     SetMemState[arma.Mat[double]](X, 1)             # <<<<<<<<<<<<<<
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 */
    SetMemState<arma::Mat<double> >(__pyx_v_X, 1);

    /* "ddl/externals/mlpack/_arma_numpy.pyx":99
 *   if GetMemState[arma.Mat[double]](X) == 0:
 *     SetMemState[arma.Mat[double]](X, 1)
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 * 
 *   return output
 */
    PyArray_ENABLEFLAGS(((PyArrayObject *)__pyx_v_output), NPY_OWNDATA);
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":101
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 *   return output             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.mat_to_numpy_d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":103
 *   return output
 * 
 * cdef numpy.ndarray[numpy.npy_intp, ndim=2] mat_to_numpy_s(arma.Mat[size_t]& X) \             # <<<<<<<<<<<<<<
 *     except +:
...
static PyArrayObject *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_mat_to_numpy_s(arma::Mat<size_t>  &__pyx_v_X) {
  npy_intp __pyx_v_dims[2];
  PyArrayObject *__pyx_v_output = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_output;
  __Pyx_Buffer __pyx_pybuffer_output;
  ...
  PyArrayObject *__pyx_t_2 = NULL;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("mat_to_numpy_s", 0);
  __pyx_pybuffer_output.pybuffer.buf = NULL;
  __pyx_pybuffer_output.refcount = 0;
  __pyx_pybuffernd_output.data = NULL;
  __pyx_pybuffernd_output.rcbuffer = &__pyx_pybuffer_output;

  /* "ddl/externals/mlpack/_arma_numpy.pyx":110
 *   # Extract dimensions.
 *   cdef numpy.npy_intp dims[2]
 *   dims[0] = <numpy.npy_intp> X.n_cols             # <<<<<<<<<<<<<<
 *   dims[1] = <numpy.npy_intp> X.n_rows
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":111
 *   cdef numpy.npy_intp dims[2]
 *   dims[0] = <numpy.npy_intp> X.n_cols
 *   dims[1] = <numpy.npy_intp> X.n_rows             # <<<<<<<<<<<<<<
 *   cdef numpy.ndarray[numpy.npy_intp, ndim=2] output = \
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":113
 *   dims[1] = <numpy.npy_intp> X.n_rows
 *   cdef numpy.ndarray[numpy.npy_intp, ndim=2] output = \
 *       numpy.PyArray_SimpleNewFromData(2, &dims[0], numpy.NPY_INTP, GetMemory(X))             # <<<<<<<<<<<<<<
 * 
 *   # Transfer memory ownership, if needed.
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(2, (&(__pyx_v_dims[0])), NPY_INTP, GetMemory(__pyx_v_X)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 113, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 113, __pyx_L1_error)
  __pyx_t_2 = ((PyArrayObject *)__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_output.rcbuffer->pybuffer, (PyObject*)__pyx_t_2, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_output = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_output.rcbuffer->pybuffer.buf = NULL;
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":116
 * 
 *   # Transfer memory ownership, if needed.
 ...
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 */
  __pyx_t_3 = ((GetMemState<arma::Mat<size_t> >(__pyx_v_X) == 0) != 0);
  if (__pyx_t_3) {

    /* "ddl/externals/mlpack/_arma_numpy.pyx":117
 *   # Transfer memory ownership, if needed.
 *   if GetMemState[arma.Mat[size_t]](X) == 0:
 *     SetMemState[arma.Mat[size_t]](X, 1)             # <<<<<<<<<<<<<<
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 */
    SetMemState<arma::Mat<size_t> >(__pyx_v_X, 1);

    /* "ddl/externals/mlpack/_arma_numpy.pyx":118
 *   if GetMemState[arma.Mat[size_t]](X) == 0:
 *     SetMemState[arma.Mat[size_t]](X, 1)
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":120
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 *   return output             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.mat_to_numpy_s", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":122
 *   return output
 * 
 * cdef arma.Row[double]* numpy_to_row_d(numpy.ndarray[numpy.double_t, ndim=1] X, \             # <<<<<<<<<<<<<<
 *                                       bool takeOwnership) except +:
...
static arma::Row<double>  *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_row_d(PyArrayObject *__pyx_v_X, bool __pyx_v_takeOwnership) {
  arma::Row<double>  *__pyx_v_m;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_X;
  __Pyx_Buffer __pyx_pybuffer_X;
  ...
  PyObject *__pyx_t_9 = NULL;
  PyObject *__pyx_t_10 = NULL;
  __Pyx_RefNannySetupContext("numpy_to_row_d", 0);
  __Pyx_INCREF((PyObject *)__pyx_v_X);
  __pyx_pybuffer_X.pybuffer.buf = NULL;
  __pyx_pybuffer_X.refcount = 0;
  __pyx_pybuffernd_X.data = NULL;
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":128
 *   owned by numpy.
 *   """
 *   if not (X.flags.c_contiguous or X.flags.owndata):             # <<<<<<<<<<<<<<
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_c_contiguous); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_owndata); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 128, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":130
 *   if not (X.flags.c_contiguous or X.flags.owndata):
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")             # <<<<<<<<<<<<<<
 *     takeOwnership = True
 * 
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_copy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 130, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyDict_New(); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 130, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_C) < 0) __PYX_ERR(0, 130, __pyx_L1_error)
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_empty_tuple, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 130, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":131
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 *     takeOwnership = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":133
 *     takeOwnership = True
 * 
 *   cdef arma.Row[double]* m = new arma.Row[double](<double*> X.data, X.shape[0],             # <<<<<<<<<<<<<<
 *       False, False)
 * 
 */
  __pyx_v_m = new arma::Row<double> (((double *)__pyx_v_X->data), (__pyx_v_X->dimensions[0]), 0, 0);

  /* "ddl/externals/mlpack/_arma_numpy.pyx":137
 * 
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:             # <<<<<<<<<<<<<<
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":138
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 *     SetMemState[arma.Row[double]](m[0], 0)
 ...
 */
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":139
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 *     SetMemState[arma.Row[double]](m[0], 0)             # <<<<<<<<<<<<<<
 * 
 *   return m
 */
    SetMemState<arma::Row<double> >((__pyx_v_m[0]), 0);
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":141
 *     SetMemState[arma.Row[double]](m[0], 0)
 * 
 *   return m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.numpy_to_row_d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":143
 *   return m
 * 
 * cdef arma.Row[size_t]* numpy_to_row_s(numpy.ndarray[numpy.npy_intp, ndim=1] X, \             # <<<<<<<<<<<<<<
 *                                       bool takeOwnership) except +:
...
static arma::Row<size_t>  *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_row_s(PyArrayObject *__pyx_v_X, bool __pyx_v_takeOwnership) {
  arma::Row<size_t>  *__pyx_v_m;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_X;
  __Pyx_Buffer __pyx_pybuffer_X;
  arma::Row<size_t>  *__pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  ...
  PyObject *__pyx_t_9 = NULL;
  PyObject *__pyx_t_10 = NULL;
  __Pyx_RefNannySetupContext("numpy_to_row_s", 0);
  __Pyx_INCREF((PyObject *)__pyx_v_X);
  __pyx_pybuffer_X.pybuffer.buf = NULL;
  __pyx_pybuffer_X.refcount = 0;
  __pyx_pybuffernd_X.data = NULL;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 143, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0];

  /* "ddl/externals/mlpack/_arma_numpy.pyx":149
 *   owned by numpy.
 *   """
 *   if not (X.flags.c_contiguous or X.flags.owndata):             # <<<<<<<<<<<<<<
 *     # If needed, make a copy where we own the memory.
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_c_contiguous); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 149, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":151
 *   if not (X.flags.c_contiguous or X.flags.owndata):
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")             # <<<<<<<<<<<<<<
 *     takeOwnership = True
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_3);
    if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_C) < 0) __PYX_ERR(0, 151, __pyx_L1_error)
    ...
    __pyx_t_6 = ((PyArrayObject *)__pyx_t_5);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
      __pyx_t_7 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_7 < 0)) {
        PyErr_Fetch(&__pyx_t_8, &__pyx_t_9, &__pyx_t_10);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
          Py_XDECREF(__pyx_t_8); Py_XDECREF(__pyx_t_9); Py_XDECREF(__pyx_t_10);
          __Pyx_RaiseBufferFallbackError();
        } else {
          PyErr_Restore(__pyx_t_8, __pyx_t_9, __pyx_t_10);
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":152
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 *     takeOwnership = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":154
 *     takeOwnership = True
 * 
 *   cdef arma.Row[size_t]* m = new arma.Row[size_t](<size_t*> X.data, X.shape[0],             # <<<<<<<<<<<<<<
 *       False, False)
 * 
 */
  __pyx_v_m = new arma::Row<size_t> (((size_t *)__pyx_v_X->data), (__pyx_v_X->dimensions[0]), 0, 0);

  /* "ddl/externals/mlpack/_arma_numpy.pyx":158
 * 
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:             # <<<<<<<<<<<<<<
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":159
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 *     SetMemState[arma.Row[size_t]](m[0], 0)
 ...
 */
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":160
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 *     SetMemState[arma.Row[size_t]](m[0], 0)             # <<<<<<<<<<<<<<
 * 
 *   return m
 */
    SetMemState<arma::Row<size_t> >((__pyx_v_m[0]), 0);
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":162
 *     SetMemState[arma.Row[size_t]](m[0], 0)
 * 
 *   return m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.numpy_to_row_s", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":164
 *   return m
 * 
 * cdef numpy.ndarray[numpy.double_t, ndim=1] row_to_numpy_d(arma.Row[double]& X) \             # <<<<<<<<<<<<<<
 *     except +:
...
static PyArrayObject *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_row_to_numpy_d(arma::Row<double>  &__pyx_v_X) {
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":170
 *   """
 *   # Extract dimensions.
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":172
 *   cdef numpy.npy_intp dim = <numpy.npy_intp> X.n_elem
 *   cdef numpy.ndarray[numpy.double_t, ndim=1] output = \
 *       numpy.PyArray_SimpleNewFromData(1, &dim, numpy.NPY_DOUBLE, GetMemory(X))             # <<<<<<<<<<<<<<
 * 
 *   # Transfer memory ownership, if needed.
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(1, (&__pyx_v_dim), NPY_DOUBLE, GetMemory(__pyx_v_X)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 172, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":175
 * 
 *   # Transfer memory ownership, if needed.
 ...
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 */
  __pyx_t_3 = ((GetMemState<arma::Row<double> >(__pyx_v_X) == 0) != 0);
  if (__pyx_t_3) {

    /* "ddl/externals/mlpack/_arma_numpy.pyx":176
 *   # Transfer memory ownership, if needed.
 *   if GetMemState[arma.Row[double]](X) == 0:
 *     SetMemState[arma.Row[double]](X, 1)             # <<<<<<<<<<<<<<
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 */
    SetMemState<arma::Row<double> >(__pyx_v_X, 1);

    /* "ddl/externals/mlpack/_arma_numpy.pyx":177
 *   if GetMemState[arma.Row[double]](X) == 0:
 *     SetMemState[arma.Row[double]](X, 1)
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":179
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 *   return output             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.row_to_numpy_d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":181
 *   return output
 * 
 * cdef numpy.ndarray[numpy.npy_intp, ndim=1] row_to_numpy_s(arma.Row[size_t]& X) \             # <<<<<<<<<<<<<<
 *     except +:
...
static PyArrayObject *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_row_to_numpy_s(arma::Row<size_t>  &__pyx_v_X) {
  npy_intp __pyx_v_dim;
  PyArrayObject *__pyx_v_output = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_output;
  __Pyx_Buffer __pyx_pybuffer_output;
  ...
  PyArrayObject *__pyx_t_2 = NULL;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("row_to_numpy_s", 0);
  __pyx_pybuffer_output.pybuffer.buf = NULL;
  __pyx_pybuffer_output.refcount = 0;
  __pyx_pybuffernd_output.data = NULL;
  __pyx_pybuffernd_output.rcbuffer = &__pyx_pybuffer_output;

  /* "ddl/externals/mlpack/_arma_numpy.pyx":187
 *   """
 *   # Extract dimensions.
 *   cdef numpy.npy_intp dim = <numpy.npy_intp> X.n_elem             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":189
 *   cdef numpy.npy_intp dim = <numpy.npy_intp> X.n_elem
 *   cdef numpy.ndarray[numpy.npy_intp, ndim=1] output = \
 *       numpy.PyArray_SimpleNewFromData(1, &dim, numpy.NPY_INTP, GetMemory(X))             # <<<<<<<<<<<<<<
 * 
 *   # Transfer memory ownership, if needed.
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(1, (&__pyx_v_dim), NPY_INTP, GetMemory(__pyx_v_X)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 189, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (!(likely(((__pyx_t_1) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_1, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 189, __pyx_L1_error)
  __pyx_t_2 = ((PyArrayObject *)__pyx_t_1);
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_output.rcbuffer->pybuffer, (PyObject*)__pyx_t_2, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_output = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_output.rcbuffer->pybuffer.buf = NULL;
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":192
 * 
 *   # Transfer memory ownership, if needed.
 ...
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 */
  __pyx_t_3 = ((GetMemState<arma::Row<size_t> >(__pyx_v_X) == 0) != 0);
  if (__pyx_t_3) {

    /* "ddl/externals/mlpack/_arma_numpy.pyx":193
 *   # Transfer memory ownership, if needed.
 *   if GetMemState[arma.Row[size_t]](X) == 0:
 *     SetMemState[arma.Row[size_t]](X, 1)             # <<<<<<<<<<<<<<
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 */
    SetMemState<arma::Row<size_t> >(__pyx_v_X, 1);

    /* "ddl/externals/mlpack/_arma_numpy.pyx":194
 *   if GetMemState[arma.Row[size_t]](X) == 0:
 *     SetMemState[arma.Row[size_t]](X, 1)
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":196
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 *   return output             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.row_to_numpy_s", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":198
 *   return output
 * 
 * cdef arma.Col[double]* numpy_to_col_d(numpy.ndarray[numpy.double_t, ndim=1] X, \             # <<<<<<<<<<<<<<
 *                                       bool takeOwnership) except +:
...
static arma::Col<double>  *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_col_d(PyArrayObject *__pyx_v_X, bool __pyx_v_takeOwnership) {
  arma::Col<double>  *__pyx_v_m;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_X;
  __Pyx_Buffer __pyx_pybuffer_X;
  ...
  PyObject *__pyx_t_9 = NULL;
  PyObject *__pyx_t_10 = NULL;
  __Pyx_RefNannySetupContext("numpy_to_col_d", 0);
  __Pyx_INCREF((PyObject *)__pyx_v_X);
  __pyx_pybuffer_X.pybuffer.buf = NULL;
  __pyx_pybuffer_X.refcount = 0;
  __pyx_pybuffernd_X.data = NULL;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn___pyx_t_5numpy_double_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 198, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0];

  /* "ddl/externals/mlpack/_arma_numpy.pyx":204
 ...
 *     X = X.copy(order="C")
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 204, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_c_contiguous); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 204, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 204, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_owndata); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 204, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":206
 *   if not (X.flags.c_contiguous or X.flags.owndata):
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")             # <<<<<<<<<<<<<<
 *     takeOwnership = True
 * 
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_copy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 206, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyDict_New(); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 206, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_order, __pyx_n_s_C) < 0) __PYX_ERR(0, 206, __pyx_L1_error)
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":207
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 *     takeOwnership = True             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":209
 *     takeOwnership = True
 * 
 *   cdef arma.Col[double]* m = new arma.Col[double](<double*> X.data, X.shape[0],             # <<<<<<<<<<<<<<
 *       False, True)
 * 
 */
  __pyx_v_m = new arma::Col<double> (((double *)__pyx_v_X->data), (__pyx_v_X->dimensions[0]), 0, 1);

  /* "ddl/externals/mlpack/_arma_numpy.pyx":213
 * 
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:             # <<<<<<<<<<<<<<
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":214
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 *     SetMemState[arma.Col[double]](m[0], 0)
 ...
 */
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":215
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 *     SetMemState[arma.Col[double]](m[0], 0)             # <<<<<<<<<<<<<<
 * 
 *   return m
 */
    SetMemState<arma::Col<double> >((__pyx_v_m[0]), 0);
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":217
 *     SetMemState[arma.Col[double]](m[0], 0)
 * 
 *   return m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.numpy_to_col_d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":219
 *   return m
 * 
 * cdef arma.Col[size_t]* numpy_to_col_s(numpy.ndarray[numpy.npy_intp, ndim=1] X, \             # <<<<<<<<<<<<<<
 *                                       bool takeOwnership) except +:
...
static arma::Col<size_t>  *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_col_s(PyArrayObject *__pyx_v_X, bool __pyx_v_takeOwnership) {
  arma::Col<size_t>  *__pyx_v_m;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_X;
  __Pyx_Buffer __pyx_pybuffer_X;
  arma::Col<size_t>  *__pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  PyObject *__pyx_t_3 = NULL;
  ...
  PyObject *__pyx_t_9 = NULL;
  PyObject *__pyx_t_10 = NULL;
  __Pyx_RefNannySetupContext("numpy_to_col_s", 0);
  __Pyx_INCREF((PyObject *)__pyx_v_X);
  __pyx_pybuffer_X.pybuffer.buf = NULL;
  __pyx_pybuffer_X.refcount = 0;
  __pyx_pybuffernd_X.data = NULL;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X.rcbuffer->pybuffer, (PyObject*)__pyx_v_X, &__Pyx_TypeInfo_nn_npy_intp, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 219, __pyx_L1_error)
  }
  __pyx_pybuffernd_X.diminfo[0].strides = __pyx_pybuffernd_X.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_X.diminfo[0].shape = __pyx_pybuffernd_X.rcbuffer->pybuffer.shape[0];

  /* "ddl/externals/mlpack/_arma_numpy.pyx":225
 *   still be owned by numpy.
 *   """
 *   if not (X.flags.c_contiguous or X.flags.owndata):             # <<<<<<<<<<<<<<
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 225, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_c_contiguous); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 225, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_flags); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 225, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_owndata); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 225, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":227
 *   if not (X.flags.c_contiguous or X.flags.owndata):
 *     # If needed, make a copy where we own the memory.
 *     X = X.copy(order="C")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_2 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_X), __pyx_n_s_copy); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 227, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    ...
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_empty_tuple, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 227, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":229
 *     X = X.copy(order="C")
 * 
 *   cdef arma.Col[size_t]* m = new arma.Col[size_t](<size_t*> X.data, X.shape[0],             # <<<<<<<<<<<<<<
 *       False, False)
 * 
 */
  __pyx_v_m = new arma::Col<size_t> (((size_t *)__pyx_v_X->data), (__pyx_v_X->dimensions[0]), 0, 0);

  /* "ddl/externals/mlpack/_arma_numpy.pyx":233
 * 
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:             # <<<<<<<<<<<<<<
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 ...
 */
  ...
  if (__pyx_t_4) {
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":234
 *   # Transfer memory ownership, if needed.
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 *     SetMemState[arma.Col[size_t]](m[0], 0)
 ...
 */
    ...
    /* "ddl/externals/mlpack/_arma_numpy.pyx":235
 *   if takeOwnership:
 *     PyArray_CLEARFLAGS(X, numpy.NPY_OWNDATA)
 *     SetMemState[arma.Col[size_t]](m[0], 0)             # <<<<<<<<<<<<<<
 * 
 *   return m
 */
    SetMemState<arma::Col<size_t> >((__pyx_v_m[0]), 0);
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":237
 *     SetMemState[arma.Col[size_t]](m[0], 0)
 * 
 *   return m             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.numpy_to_col_s", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_X.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":239
 *   return m
 * 
 * cdef numpy.ndarray[numpy.double_t, ndim=1] col_to_numpy_d(arma.Col[double]& X) \             # <<<<<<<<<<<<<<
 *     except +:
...
static PyArrayObject *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_col_to_numpy_d(arma::Col<double>  &__pyx_v_X) {
  npy_intp __pyx_v_dim;
  PyArrayObject *__pyx_v_output = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_output;
  __Pyx_Buffer __pyx_pybuffer_output;
  ...
  PyArrayObject *__pyx_t_2 = NULL;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("col_to_numpy_d", 0);
  __pyx_pybuffer_output.pybuffer.buf = NULL;
  __pyx_pybuffer_output.refcount = 0;
  __pyx_pybuffernd_output.data = NULL;
  __pyx_pybuffernd_output.rcbuffer = &__pyx_pybuffer_output;

  /* "ddl/externals/mlpack/_arma_numpy.pyx":245
 *   """
 *   # Extract dimension.
 *   cdef numpy.npy_intp dim = <numpy.npy_intp> X.n_elem             # <<<<<<<<<<<<<<
 *   cdef numpy.ndarray[numpy.double_t, ndim=1] output = \
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":247
 *   cdef numpy.npy_intp dim = <numpy.npy_intp> X.n_elem
 *   cdef numpy.ndarray[numpy.double_t, ndim=1] output = \
 *       numpy.PyArray_SimpleNewFromData(1, &dim, numpy.NPY_DOUBLE, GetMemory(X))             # <<<<<<<<<<<<<<
 * 
 *   # Transfer memory ownership, if needed.
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(1, (&__pyx_v_dim), NPY_DOUBLE, GetMemory(__pyx_v_X)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 247, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":250
 * 
 *   # Transfer memory ownership, if needed.
 ...
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 */
  __pyx_t_3 = ((GetMemState<arma::Col<double> >(__pyx_v_X) == 0) != 0);
  if (__pyx_t_3) {

    /* "ddl/externals/mlpack/_arma_numpy.pyx":251
 *   # Transfer memory ownership, if needed.
 *   if GetMemState[arma.Col[double]](X) == 0:
 *     SetMemState[arma.Col[double]](X, 1)             # <<<<<<<<<<<<<<
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 */
    SetMemState<arma::Col<double> >(__pyx_v_X, 1);

    /* "ddl/externals/mlpack/_arma_numpy.pyx":252
 *   if GetMemState[arma.Col[double]](X) == 0:
 *     SetMemState[arma.Col[double]](X, 1)
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":254
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 *   return output             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.col_to_numpy_d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
...
/* "ddl/externals/mlpack/_arma_numpy.pyx":256
 *   return output
 * 
 * cdef numpy.ndarray[numpy.npy_intp, ndim=1] col_to_numpy_s(arma.Col[size_t]& X) \             # <<<<<<<<<<<<<<
 *     except +:
...
static PyArrayObject *__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_col_to_numpy_s(arma::Col<size_t>  &__pyx_v_X) {
  npy_intp __pyx_v_dim;
  PyArrayObject *__pyx_v_output = 0;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_output;
  __Pyx_Buffer __pyx_pybuffer_output;
  ...
  PyArrayObject *__pyx_t_2 = NULL;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("col_to_numpy_s", 0);
  __pyx_pybuffer_output.pybuffer.buf = NULL;
  __pyx_pybuffer_output.refcount = 0;
  __pyx_pybuffernd_output.data = NULL;
  __pyx_pybuffernd_output.rcbuffer = &__pyx_pybuffer_output;

  /* "ddl/externals/mlpack/_arma_numpy.pyx":262
 *   """
 *   # Extract dimension.
 *   cdef numpy.npy_intp dim = <numpy.npy_intp> X.n_elem             # <<<<<<<<<<<<<<
 *   cdef numpy.ndarray[numpy.npy_intp, ndim=1] output = \
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":264
 *   cdef numpy.npy_intp dim = <numpy.npy_intp> X.n_elem
 *   cdef numpy.ndarray[numpy.npy_intp, ndim=1] output = \
 *       numpy.PyArray_SimpleNewFromData(1, &dim, numpy.NPY_INTP, GetMemory(X))             # <<<<<<<<<<<<<<
 * 
 *   # Transfer memory ownership, if needed.
 */
  __pyx_t_1 = PyArray_SimpleNewFromData(1, (&__pyx_v_dim), NPY_INTP, GetMemory(__pyx_v_X)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 264, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":267
 * 
 *   # Transfer memory ownership, if needed.
 ...
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 */
  __pyx_t_3 = ((GetMemState<arma::Col<size_t> >(__pyx_v_X) == 0) != 0);
  if (__pyx_t_3) {

    /* "ddl/externals/mlpack/_arma_numpy.pyx":268
 *   # Transfer memory ownership, if needed.
 *   if GetMemState[arma.Col[size_t]](X) == 0:
 *     SetMemState[arma.Col[size_t]](X, 1)             # <<<<<<<<<<<<<<
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 */
    SetMemState<arma::Col<size_t> >(__pyx_v_X, 1);

    /* "ddl/externals/mlpack/_arma_numpy.pyx":269
 *   if GetMemState[arma.Col[size_t]](X) == 0:
 *     SetMemState[arma.Col[size_t]](X, 1)
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":271
 *     PyArray_ENABLEFLAGS(output, numpy.NPY_OWNDATA)
 * 
 *   return output             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("ddl.externals.mlpack._arma_numpy.col_to_numpy_s", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_output.rcbuffer->pybuffer);
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    "_arma_numpy",
    __pyx_k_arma_numpy_pyx_Armadillo_numpy, /* m_doc */
    -1, /* m_size */
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_arma_numpy(void); /*proto*/
PyMODINIT_FUNC init_arma_numpy(void)
#else
PyMODINIT_FUNC PyInit__arma_numpy(void); /*proto*/
PyMODINIT_FUNC PyInit__arma_numpy(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_t_2;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__arma_numpy(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_arma_numpy", __pyx_methods, __pyx_k_arma_numpy_pyx_Armadillo_numpy, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_ddl__externals__mlpack___arma_numpy) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "ddl.externals.mlpack._arma_numpy")) {
      if (unlikely(PyDict_SetItemString(modules, "ddl.externals.mlpack._arma_numpy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("numpy_to_mat_d", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_mat_d, "arma::Mat<double>  *(PyArrayObject *, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("numpy_to_mat_s", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_mat_s, "arma::Mat<size_t>  *(PyArrayObject *, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("mat_to_numpy_d", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_mat_to_numpy_d, "PyArrayObject *(arma::Mat<double>  &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("mat_to_numpy_s", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_mat_to_numpy_s, "PyArrayObject *(arma::Mat<size_t>  &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("numpy_to_row_d", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_row_d, "arma::Row<double>  *(PyArrayObject *, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("numpy_to_row_s", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_row_s, "arma::Row<size_t>  *(PyArrayObject *, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("row_to_numpy_d", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_row_to_numpy_d, "PyArrayObject *(arma::Row<double>  &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("row_to_numpy_s", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_row_to_numpy_s, "PyArrayObject *(arma::Row<size_t>  &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("numpy_to_col_d", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_col_d, "arma::Col<double>  *(PyArrayObject *, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("numpy_to_col_s", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_numpy_to_col_s, "arma::Col<size_t>  *(PyArrayObject *, bool)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("col_to_numpy_d", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_col_to_numpy_d, "PyArrayObject *(arma::Col<double>  &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("col_to_numpy_s", (void (*)(void))__pyx_f_3ddl_9externals_6mlpack_11_arma_numpy_col_to_numpy_s, "PyArrayObject *(arma::Col<size_t>  &)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":22
 * cimport cython
 * cimport numpy
 * import numpy             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":24
 * import numpy
 * 
 * numpy.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "ddl/externals/mlpack/_arma_numpy.pyx":1
 * #!/usr/bin/env python             # <<<<<<<<<<<<<<
 * """
 * arma_numpy.pyx: Armadillo/numpy interface functionality.
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init ddl.externals.mlpack._arma_numpy", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init ddl.externals.mlpack._arma_numpy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
