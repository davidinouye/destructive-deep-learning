# -*- coding: utf-8 -*-
#
# EDITED based on https://samnicholls.net/2016/06/15/how-to-sphinx-readthedocs/
#
...
latex_documents = [
    (master_doc, 'destructive-deep-learning.tex', 'Destructive Deep Learning (ddl) Documentation',
